...
public class BaseDaoImpl<T> implements BaseDaoI<T> {
	...
	@Override
	public List<T> findBySql(String sql,Class obj) {
		SQLQuery q = getCurrentSession().createSQLQuery(sql);
//		q.setResultTransformer(Transformers.ALIAS_TO_ENTITY_MAP).list();
		
		return q.setResultTransformer(Transformers.aliasToBean(obj)).list();
	}
	...
	@Override
	public List findBySql(String sql, Map<String, Object> params,Class obj) {
		SQLQuery q = getCurrentSession().createSQLQuery(sql);
		if (params != null && !params.isEmpty()) {
			for (String key : params.keySet()) {
				q.setParameter(key, params.get(key));
