		              ...
		              <table class="table">
		                ...
		                <tbody>
		                  <c:forEach items="${lifes}" var="life">
		                  	<tr>
			                  	<td title="${life.motif}">
			                  		<a href="${pageContext.request.contextPath}/LifeAction!gainLife.action?life.id=${life.id}">${life.motif}</a>
			                  	</td>
			                  	<td>${life.content}</td>
			                  	<td>${fn:substring(life.createTime, 0, 10)}</td>
			                  	<td>${fn:substring(life.updateTime, 0, 10)}</td>
		                  	</tr>
		                  </c:forEach>
		                </tbody>
		              </table>
