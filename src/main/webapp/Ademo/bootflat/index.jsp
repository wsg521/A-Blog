  ...
  <body class="home">
    <div class="docs-header header--noBackground">
      ...
      <div class="index">
		...
		<p class="adpacks">
			<script async type="text/javascript" src="js/cdn.adpacks.com.adpacks.js" id="_adpacks_js"></script>
	    </p>
      ...
      <div class="site-footer">
        <div class="container">
          <div class="download">
            ...
            <a href="http://www.smartaddon.com/?share" title="Share Button" onclick="return sa_tellafriend('','bookmarks')"><img alt="Share" src="http://bootflat.github.io/img/share.gif" border="0" />000</a>
            <!-- SmartAddon END -->
          </div>
          <hr class="dashed" />
          <div class="row">
